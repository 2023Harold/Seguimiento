    ...
    $("input:file").each(function() {
        ...
        if (!$(this).hasClass("key")) {
            $(id).fileinput({
                ...
                showUpload: false,
                showCancel: false,
                msgUploadEmpty: 'El archivo seleccionado no es válido para su envío. Revise que el tamaño y tipo de archivo coincida con lo permitido. (Si el error persiste, por favor contacte al administrador del sistema).',
