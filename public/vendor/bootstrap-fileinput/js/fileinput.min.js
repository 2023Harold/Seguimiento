...
! function(e) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], e) : e("object" == typeof module && "object" == typeof module.exports ? require("jquery") : window.jQuery) }(function(e) {
    ...
    t = {
        ...
        getZoomPlaceholder: function() {
            var e, i = t.SCRIPT_SRC,
                a = "?kvTemp__2873389129__=";
            return i ? (e = i.substring(0, i.lastIndexOf("/")), e.substring(0, e.lastIndexOf("/") + 1) + "img/loading.gif" + a) : a
        },
        isBs: function(t) { var i = e.trim((e.fn.fileinputBsVersion || "") + ""); return t = parseInt(t, 10), i ? t === parseInt(i.charAt(0), 10) : 4 === t },
        defaultButtonCss: function(e) { return "btn-secondary btn-" + (e ? "" : "outline-") + "secondary" },
        ...
        isEmpty: function(i, a) { return void 0 === i || null === i || "" === i ? !0 : t.isString(i) && a ? "" === e.trim(i) : t.isArray(i) ? 0 === i.length : !(!e.isPlainObject(i) || !e.isEmptyObject(i)) },
        isArray: function(e) { return Array.isArray(e) || "[object Array]" === Object.prototype.toString.call(e) },
        isString: function(e) { return "[object String]" === Object.prototype.toString.call(e) },
            ...
            stash: function(i) {
                ...
                n.find("[style]").each(function(i, r) {
                    var n = e(r),
                        ...
                        s = t.uniqId(),
                        l = {};
                    o && o.length && (e(o).each(function() { l[this] = o[this] }), a.domElementsStyles[s] = l, n.removeAttr("style").attr(a.CSP_ATTRIB, s))
        ...
        whenAll: function(i) {
            var a, r, n, o, s, l, d = [].slice,
                ...
                f = c.length,
                m = f;
            for (n = o = s = Array(f), l = function(e, t, i) { return function() { i !== c && p++, u.notifyWith(t[e] = this, i[e] = d.call(arguments)), --m || u[(p ? "reject" : "resolve") + "With"](t, i) } }, a = 0; f > a; a++)(r = c[a]) && e.isFunction(r.promise) ? r.promise().done(l(a, s, c)).fail(l(a, n, o)) : (u.notifyWith(this, r), --m);
            ...
            i.uploadStartTime = t.now(), i.fileManager = {
                ...
                getUploadStats: function(e, a, r) {
                    ...
                    return setTimeout(function() {
                        ...
                        o.bps = 64 * (a > 0 ? r / a : 0)
                    }, u), n = { fileId: e, started: s, elapsed: l, loaded: a, total: r, bps: o.bps, bitrate: i._getSize(o.bps, !1, i.bitRateUnits), pendingBytes: c }, e ? o.stats[e] = n : o.stats = n, n
                },
        ...
        _initResumableUpload: function() {
            ...
            if (a.enableResumableUpload) {
                ...
                i = a.resumableManager = {
                    init: function(e, t, n) { i.logs = [], i.stack = [], i.error = "", i.id = e, i.file = t.file, i.fileName = t.name, i.fileIndex = n, i.completed = !1, i.lastProgress = 0, a.showPreview && (i.$thumb = o.getThumb(e) || null, i.$progress = i.$btnDelete = null, i.$thumb && i.$thumb.length && (i.$progress = i.$thumb.find(".file-thumb-progress"), i.$btnDelete = i.$thumb.find(".kv-file-remove"))), i.chunkSize = r.chunkSize * a.bytesToKB, i.chunkCount = i.getTotalChunks() },
                    setAjaxError: function(e, t, o, s) { e.responseJSON && e.responseJSON.error && (o = e.responseJSON.error.toString()), s || (i.error = o), r.showErrorLog && a._log(n.ajaxError, { status: e.status, error: o, text: e.responseText || "" }) },
                    ...
                    processUpload: function() {
                        ...
                        return r.testUrl ? (n = new FormData, s = o.stack[f], a._setUploadData(n, { fileId: f, fileName: s.fileName, fileSize: s.size, fileRelativePath: s.relativePath, chunkSize: i.chunkSize, chunkCount: i.chunkCount }), l = function(e) { p = a._getOutData(n, e), a._raise("filetestbeforesend", [f, o, i, p]) }, d = function(r, s, l) {
                        ...
                        }, c = function(e, t, r) { p = a._getOutData(n, e), a._raise("filetestajaxerror", [f, o, i, p]), i.setAjaxError(e, t, r, !0), i.uploadResumable() }, u = function() { a._raise("filetestcomplete", [f, o, i, a._getOutData(n)]) }, void a._ajaxSubmit(l, d, u, c, n, f, i.fileIndex, r.testUrl)) : void i.uploadResumable()
                    },
                    ...
                    sendAjax: function(e, s, l) {
                        var d, c = i.chunkSize,
                            ...
                            m = t.logMessages,
                            g = i.$btnDelete,
                            v = function(e, t) { t && (e = e.setTokens(t)), e = m.resumableRequestError.setTokens({ msg: e }), a._log(e), l.reject(e) };
        ...
        _initPreviewCache: function() {
            ...
            i.previewCache = {
                ...
                add: function(e, a, r, n) { var o, s = i.previewCache.data; return e && e.length ? (o = e.length - 1, t.isArray(e) || (e = e.split(i.initialPreviewDelimiter)), n && s.content ? (o = s.content.push(e[0]) - 1, s.config[o] = a, s.tags[o] = r) : (s.content = e, s.config = a, s.tags = r), i.previewCache.clean(s), o) : 0 },
                set: function(e, a, r, n) {
                    var o, s, l = i.previewCache.data;
                    if (e && e.length && (t.isArray(e) || (e = e.split(i.initialPreviewDelimiter)), s = e.filter(function(e) { return null !== e }), s.length)) {
                        if (void 0 === l.content && (l.content = []), void 0 === l.config && (l.config = []), void 0 === l.tags && (l.tags = []), n) { for (o = 0; o < e.length; o++) e[o] && l.content.push(e[o]); for (o = 0; o < a.length; o++) a[o] && l.config.push(a[o]); for (o = 0; o < r.length; o++) r[o] && l.tags.push(r[o]) } else l.content = e, l.config = a, l.tags = r;
                ...
                footer: function(e, a, r) {
                    ...
                    var o, s = n.config[e],
                        ...
                        y = c === !1 && a;
                    return _ = _ && s.downloadUrl !== !1 && !!v, o = i._renderFileActions(s, !1, _, b, C, x, y, c, u, !0, v, h), i._getLayoutTemplate("footer").setTokens({ progress: i._renderThumbProgress(), actions: o, caption: l, size: i._getSize(r), width: d, indicator: "" })
                }
            }, i.previewCache.init()
        },
        ...
        _scanDroppedItems: function(e, i, a) {
            a = a || "";
            var r, n, o, s = this,
                l = function(e) { s._log(t.logMessages.badDroppedFiles), s._log(e) };
            e.isFile ? e.file(function(e) { a && (e.newPath = a + e.name), i.push(e) }, l) : e.isDirectory && (n = e.createReader(), (o = function() {
        ...
        _zoneDrop: function(e) {
            ...
            if (e.preventDefault(), !a.isDisabled && !t.isEmpty(n) && a._raise("fileDragDrop", { sourceEvent: e, files: n }))
                if (s > 0) {
                    ...
                    setTimeout(function() { a._dropFiles(e, n) }, 500)
        ...
        _initSortable: function() {
            var i, a, r, n, o = this,
                ...
                p = window.Sortable;
            p && 0 !== s.find(l).length && (a = d.length ? d : c.length ? c : o.$container, r = function() { a.addClass("file-grabbing") }, n = function() { a.removeClass("file-grabbing") }, i = {
                ...
                onSort: function(i) {
                    var a, r = i.oldIndex,
                        ...
                        d = l > 0 && n >= l,
                        c = e(i.item);
                    d && (n = l - 1), o.initialPreview = t.moveArray(o.initialPreview, r, n, u), o.initialPreviewConfig = t.moveArray(o.initialPreviewConfig, r, n, u), o.previewCache.init(), o.getFrames(".file-preview-initial").each(function() { e(this).attr("data-fileindex", t.INIT_FLAG + s), s++ }), d && (a = o.getFrames(":not(.file-preview-initial):first"), a.length && c.slideUp(function() { c.insertBefore(a).slideDown() })), o._raise("filesorted", { previewId: c.attr("id"), oldIndex: r, newIndex: n, stack: o.initialPreviewConfig })
                }
        ...
        _setZoomContent: function(i, a) {
            ...
            y && (y = decodeURIComponent(y), g = w.html().replace(v.zoomPlaceholder, "").setTokens({ zoomData: y }), w.html(g), i.data("zoom", ""), w.attr("data-zoom", y)), n = w.attr("data-template") || "generic", r = w.find(".kv-file-content"), o = r.length ? r.html() : "", f = i.data("caption") || v.msgZoomModalHeading, m = i.data("size") || "", u = i.data("description") || "", b.find(".kv-zoom-caption").attr("title", f).html(f), b.find(".kv-zoom-size").html(m), p = b.find(".kv-zoom-description").hide(), u && (v.showDescriptionClose && (u = v._getLayoutTemplate("descriptionClose").setTokens({ closeIcon: v.previewZoomButtonIcons.close }) + "</button>" + u), p.show().html(u), v.showDescriptionClose && v._handler(b.find(".kv-desc-hide"), "click", function() { e(this).parent().fadeOut("fast", function() { b.focus() }) })), s = b.find(".kv-zoom-body"), b.removeClass("kv-single-content"), a ? (c = s.addClass("file-thumb-loading").clone().insertAfter(s), t.setHtml(s, o).hide(), c.fadeOut("fast", function() { s.fadeIn("fast", function() { s.removeClass("file-thumb-loading") }), c.remove() })) : t.setHtml(s, o), d = v.previewZoomSettings[n], d && (l = s.find(".kv-preview-data"), t.addCss(l, "file-zoom-detail"), e.each(d, function(e, t) { l.css(e, t), (l.attr("width") && "width" === e || l.attr("height") && "height" === e) && l.removeAttr(e) })), b.data("previewId", h), v._handler(b.find(".btn-kv-prev"), "click", function() { v._zoomSlideShow("prev", h) }), v._handler(b.find(".btn-kv-next"), "click", function() { v._zoomSlideShow("next", h) }), v._handler(_, "click", function() { v._resizeZoomDialog(!0) }), v._handler(C, "click", function() { v._resizeZoomDialog(!1) }), v._handler(x, "click", function() {
                ...
                t.is(":visible") ? (e = t.outerHeight(!0), t.slideUp("slow", function() { a.find(".btn").appendTo(i), r(e) })) : (i.find(".btn").appendTo(a), t.slideDown("slow", function() { r() })), b.focus()
                ...
                [i, a] = v.rtl ? [39, 37] : [37, 39], e.each({ prev: [o, i], next: [s, a] }, function(e, t) {
                    var i = t[0],
                        a = t[1];
                    r === a && i.length && (b.focus(), i.attr("disabled") || (i.blur(), setTimeout(function() { i.focus(), v._zoomSlideShow(e, l), setTimeout(function() { i.attr("disabled") && b.focus() }, n) }, n)))
                })
            })
        },
        _showModal: function(e) {
            var i = this,
                a = i.$modal;
            e && e.length && (t.initModal(a), t.setHtml(a, i._getModalContent()), i._setZoomContent(e), a.data({ backdrop: !1, fileinputPluginId: i.$element.attr("id") }), a.find(".kv-zoom-body").css("height", i.zoomModalHeight), a.modal("show"), i._initZoomButtons())
        },
        ...
        _uploadSingle: function(i, a, r, n) {
            var o, s, l, d, c, u, p, f, m, g, v, h, w, b = this,
                _ = b.fileManager,
                C = _.count(),
                x = new FormData,
                y = b._getThumbId(a),
                ...
                I = function() { n && n.resolve && n.resolve() },
                E = function() { n && n.reject && n.reject() };
            b.enableResumableUpload || (b.uploadInitiated = !0, b.showPreview && (s = _.getThumb(a), p = s.find(".file-thumb-progress"), d = s.find(".kv-file-upload"), c = s.find(".kv-file-remove"), p.show()), 0 === C || !T || b.showPreview && d && d.hasClass("disabled") || b._abort(F) || (w = function() { u ? _.errors.push(a) : _.removeFile(a), _.setProcessed(a), _.isProcessed() && (b.fileBatchCompleted = !0, l()) }, l = function() {
                var e;
            ...
            }, f = function(n) { o = b._getOutData(x, n), _.initStats(a), b.fileBatchCompleted = !1, r || (b.ajaxAborted = !1), b.showPreview && (s.hasClass("file-preview-success") || (b._setThumbStatus(s, "Loading"), t.addCss(s, "file-uploading")), d.attr("disabled", !0), c.attr("disabled", !0)), r || b.lock(), -1 !== _.errors.indexOf(a) && delete _.errors[a], b._raise("filepreupload", [o, y, i, b._getThumbFileId(s)]), e.extend(!0, F, o), b._abort(F) && (n.abort(), r || (b._setThumbStatus(s, "New"), s.removeClass("file-uploading"), d.removeAttr("disabled"), c.removeAttr("disabled")), b._setProgressCancelled()) }, g = function(n, l, c) {
                var f = b.showPreview && s.attr("id") ? s.attr("id") : y;
                o = b._getOutData(x, c, n), e.extend(!0, F, o), setTimeout(function() { t.isEmpty(n) || t.isEmpty(n.error) ? (b.showPreview && (b._setThumbStatus(s, "Success"), d.hide(), b._initUploadSuccess(n, s, r), b._setProgress(101, p)), b._raise("fileuploaded", [o, f, i, b._getThumbFileId(s)]), r ? (w(), I()) : b.fileManager.remove(s)) : (u = !0, m = b._parseError(P, c, b.msgUploadError, b.fileManager.getFileName(a)), b._showFileError(m, F), b._setPreviewError(s, !0), b.retryErrorUploads || d.hide(), r && (w(), I()), b._setProgress(101, b._getFrame(f).find(".file-thumb-progress"), b.msgUploadError)) }, b.processDelay)
            }, v = function() { b.showPreview && (d.removeAttr("disabled"), c.removeAttr("disabled"), s.removeClass("file-uploading")), r ? l() : (b.unlock(!1), b._clearFileInput()), b._initSuccessThumbs() }, h = function(t, i, n) {
                m = b._parseError(P, t, n, b.fileManager.getFileName(a)), u = !0, setTimeout(function() {
                    var i;
                    r && (w(), E()), b.fileManager.setProgress(a, 100), b._setPreviewError(s, !0), b.retryErrorUploads || d.hide(), e.extend(!0, F, b._getOutData(x, t)), b._setProgress(101, b.$progress, b.msgAjaxProgressError.replace("{operation}", P)), i = b.showPreview && s ? s.find(".file-thumb-progress") : "", b._setProgress(101, i, b.msgUploadError), b._showFileError(m, F)
                }, b.processDelay)
            }, b._setFileData(x, k.file, S, a), b._setUploadData(x, { fileId: a }), b._ajaxSubmit(f, g, v, h, x, a, i)))
        },
        ...
        _uploadBatch: function() {
            ...
            if (0 !== c && p && !l._abort(u)) {
                s = function() { l.fileManager.clear(), l._clearFileInput() }, i = function(i) {
                    l.lock(), d.initStats();
                ...
                }, n = function() { l.unlock(), l._initSuccessThumbs(), l._clearFileInput(), l._raise("filebatchuploadcomplete", [l.fileManager.stack, l._getExtraData()]) }, r = function(t, i, a) {
                ...
                var g = 0;
                e.each(l.fileManager.stack, function(e, i) { t.isEmpty(i.file) || l._setFileData(f, i.file, i.nameFmt || "untitled_" + g, e), g++ }), l._ajaxSubmit(i, a, n, r, f)
            }
        },
        ...
        _setProgress: function(e, i, a, r) {
            ...
            if (i = i || n.$progress, i.length) {
                ...
                e >= 100 && (r = ""), t.isEmpty(c) || (o = l && s > l && 100 >= e ? c.setTokens({ percent: l, status: n.msgUploadThreshold }) : c.setTokens({ percent: s, status: e > 100 ? n.msgUploadEnd : s + "%" }), r = r || "", o = o.setTokens({ stats: r }), t.setHtml(i, o), a && t.setHtml(i.find('[role="progressbar"]'), a))
            }
        },
        ...
        _setFileUploadStats: function(i, a, r) {
            ...
            if (n.showPreview || o && o.length) {
                ...
                } else l.setProgress(i, a), o = c && c.length ? c.find(".file-thumb-progress") : null, n._setProgress(a, o, null, n._getStats(r)), e.each(l.stats, function(e, t) { u += t.loaded }), f.pendingBytes = p - u, s = t.round(u / p * 100), n._setProgress(s, null, null, n._getStats(f))
            }
        },
        ...
        _isValidSize: function(e, i, a, r, n, o) {
            var s, l, d, c = this,
                u = "Small" === e ? "min" : "max",
                p = c[u + "Image" + i];
            return t.isEmpty(p) || !a.length ? !0 : (d = a[0], l = "Width" === i ? d.naturalWidth || d.width : d.naturalHeight || d.height, ("Small" === e ? l >= p : p >= l) ? !0 : (s = c["msgImage" + i + e] || 'Image "{name}" has a size validation error (limit "{size}").', c._showFileError(s.setTokens({ name: n, size: p, dimension: l }), o), c._setPreviewError(r), c.fileManager.remove(r), c._clearFileInput(), !1))
        },
        ...
        _validateImage: function(e, t, i, a, r, n, o) {
            ...
            i = i || "Untitled", m.one("load", function() {
                m.data("validated") || (m.data("validated", !0), l = p.width(), d = u.width(), l > d && m.css("width", "100%"), s = { ind: f, id: e, fileId: t }, setTimeout(function() {
                    var l, d;
                    l = c._isValidSize("Small", "Width", m, p, i, s), d = c._isValidSize("Small", "Height", m, p, i, s), c.resizeImage || (l = l && c._isValidSize("Large", "Width", m, p, i, s), d = d && c._isValidSize("Large", "Height", m, p, i, s)), c._raise("fileimageloaded", [e]), p.data("exif", o), l && d && (c.fileManager.addImage(t, { ind: f, img: m, thumb: p, pid: e, typ: a, siz: r, validated: !1, imgData: n, exifObj: o }), c._validateAllImages())
                }, c.processDelay))
            }).one("error", function() { c._raise("fileimageloaderror", [e]) })
        },
        ...
        _getResizedImage: function(i, a, r, n) {
            var o, s, l, d, c, u, p, f, m, g, v = this,
                ...
                I = a.thumb,
                E = a.exifObj;
            if (c = function(e, t, i) { v.isAjaxUpload ? v._showFileError(e, t, i) : v._showError(e, t, i), v._setPreviewError(I) }, f = v.fileManager.getFile(i), m = { id: F, index: S, fileId: i }, g = [i, F, S], (!f || !y || C >= w && x >= b) && (y && f && v._raise("fileimageresized", g), r.val++, r.val === n && v._raise("fileimagesresized"), !y)) return void c(v.msgImageResizeError, m, "fileimageresizeerror");
            ...
            try { P.drawImage(h, 0, 0, w, b), d = T.toDataURL(k, v.resizeQuality), E && (p = window.piexif.dump(E), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), v.fileManager.setFile(i, o), v._raise("fileimageresized", g), r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(v.msgImageResizeError, m, "fileimageresizeerror") } catch (A) { r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), u = v.msgImageResizeException.replace("{errors}", A.message), c(u, m, "fileimageresizeexception") }
        },
        ...
        _renderButton: function(e) {
            ...
            return a = i._setTabIndex(e, a), r += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", t.isEmpty(s) || (s = ' <span class="' + i.buttonLabelClass + '">' + s + "</span>"), a.setTokens({ type: d, css: r, title: n, status: l, icon: o, label: s })
        },
        ...
        _renderFileFooter: function(e, i, a, r, n) {
            ...
            return a = l._getSize(a), s = { type: e, caption: i, size: a, width: r, progress: "", indicator: w }, l.isAjaxUpload ? (s.progress = l._renderThumbProgress(), s.actions = l._renderFileActions(s, p, !1, c, f, u, !1, !1, !1)) : s.actions = l._renderFileActions(s, !1, !1, !1, f, u, !1, !1, !1), o = m.setTokens(s), o = t.replaceTags(o, l.previewThumbTags)
        },
        _renderFileActions: function(e, t, i, a, r, n, o, s, l, d, c, u) {
            ...
            return a && (w = p._getLayoutTemplate("actionDelete").setTokens({ removeClass: T, removeIcon: x.removeIcon, removeTitle: x.removeTitle, dataUrl: m, dataKey: h, key: l })), t && (b = p._getLayoutTemplate("actionUpload").setTokens({ uploadClass: x.uploadClass, uploadIcon: x.uploadIcon, uploadTitle: x.uploadTitle })), i && (_ = p._getLayoutTemplate("actionDownload").setTokens({ downloadClass: x.downloadClass, downloadIcon: x.downloadIcon, downloadTitle: x.downloadTitle, downloadUrl: c || p.initialPreviewDownloadUrl }), _ = _.setTokens({ filename: u, key: l })), r && (g = p._getLayoutTemplate("actionZoom").setTokens({ zoomClass: x.zoomClass, zoomIcon: x.zoomIcon, zoomTitle: x.zoomTitle })), n && d && (f = "drag-handle-init " + x.dragClass, v = p._getLayoutTemplate("actionDrag").setTokens({ dragClass: f, dragTitle: x.dragTitle, dragIcon: x.dragIcon })), C.setTokens({ "delete": w, upload: b, download: _, zoom: g, drag: v, other: y })
        },
        _browse: function(e) {
            var t = this;
        ...
        _initFileSelected: function() {
            ...
            a.length ? a.off(r).on("focusout.fileinput", function() { t._toggleLoading("show") }).on("focusin.fileinput", function() { setTimeout(function() { i.val() || (t._toggleLoading("hide"), t._setFileDropZoneTitle()), a.off(r) }, 2500) }) : t._toggleLoading("hide")
        },
        readFiles: function(i) {
            ...
            r.fileManager.clearImages(), e.each(i, function(e, t) {
                ...
                r.lock(!0);
                var x, y, T, P, k, F, S, I, E, A, z, D = i[w],
                    j = r._getFileId(D),
                    $ = c + "-" + j,
                    U = D && D.size || 0,
                    M = r._getSize(U, !0),
                    ...
                    q = function() {
                        var e = !!C.loadedImages[j],
                            t = d.setTokens({ index: w + 1, files: u, percent: 50, name: B });
                        setTimeout(function() { s.html(t), r._updateFileDetails(u), a(w + 1) }, r.processDelay), r._raise("fileloaded", [D, $, j, w, n]) && r.isAjaxUpload ? e || C.add(D) : e && C.removeFile(j)
                    };
                if (D) {
                    if (S = C.getId(D), m > 0)
                        for (x = 0; m > x; x++) k = f[x], F = r.msgFileTypes[k] || k, H += 0 === x ? F : ", " + F;
                    if (B === !1) return void a(w + 1);
                    if (0 === B.length) return y = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(D), "[unknown]")), void h(y, D, $, w, S);
                    if (t.isEmpty(g) || (L = new RegExp("\\.(" + g.join("|") + ")$", "i")), r.isAjaxUpload && C.exists(S) || r._getFrame($, !0).length) { var K = { id: $, index: w, fileId: S, file: D, files: i }; return y = r.msgDuplicateFile.setTokens({ name: B, size: M }), void(r.isAjaxUpload ? (r.duplicateErrors.push(y), r.isDuplicateError = !0, r._raise("fileduplicateerror", [D, S, B, M, $, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(y, K), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u))) }
                    if (r.maxFileSize > 0 && O > r.maxFileSize) return y = r.msgSizeTooLarge.setTokens({ name: B, size: M, maxSize: r._getSize(r.maxFileSize * r.bytesToKB, !0) }), void h(y, D, $, w, S);
                    if (null !== r.minFileSize && O <= t.getNum(r.minFileSize)) return y = r.msgSizeTooSmall.setTokens({ name: B, size: M, minSize: r._getSize(r.minFileSize * r.bytesToKB, !0) }), void h(y, D, $, w, S);
                    if (!t.isEmpty(f) && t.isArray(f)) { for (x = 0; x < f.length; x += 1) P = f[x], E = p[P], Z += E && "function" == typeof E && E(D.type, t.getFileName(D)) ? 1 : 0; if (0 === Z) return y = r.msgInvalidFileType.setTokens({ name: B, types: H }), void h(y, D, $, w, S) }
                    if (0 === Z && !t.isEmpty(g) && t.isArray(g) && !t.isEmpty(L) && (T = t.compare(B, L), Z += t.isEmpty(T) ? 0 : T.length, 0 === Z)) return y = r.msgInvalidFileExtension.setTokens({ name: B, extensions: v }), void h(y, D, $, w, S);
                    if (!r._canPreview(D)) return I = r._raise("filebeforeload", [D, w, n]), r.isAjaxUpload && I && C.add(D), r.showPreview && I && (o.addClass("file-thumb-loading"), r._initCapStatus("processing"), r._previewDefault(D), r._initFileActions()), void setTimeout(function() { I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [D, $, j, w]) }, 10);
                    A = R(D.type, B), s.html(l.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), r._initCapStatus("processing"), n.onerror = function(e) { r._errorHandler(e, B) }, n.onload = function(i) {
                        var a, l, d, c, u, f, m = [],
                            g = function() {
                                var e = new FileReader;
                                e.onerror = function(e) { r._errorHandler(e, B) }, e.onload = function(e) { return r.isAjaxUpload && !r._raise("filebeforeload", [D, w, n]) ? (W = !0, r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable()) : (r._previewFile(w, D, e, N, l), r._initFileActions(), void q()) }, e.readAsDataURL(D)
                            };
                        if (l = { name: B, type: D.type }, e.each(p, function(e, t) { "object" !== e && "other" !== e && "function" == typeof t && t(D.type, B) && V++ }), 0 === V) { for (d = new Uint8Array(i.target.result), x = 0; x < d.length; x++) c = d[x].toString(16), m.push(c); if (a = m.join("").toLowerCase().substring(0, 8), f = t.getMimeType(a, "", ""), t.isEmpty(f) && (u = t.arrayBuffer2String(n.result), f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, D.type)), l = { name: B, type: f }, A = R(f, "")) return void g(z) }
                        return r.isAjaxUpload && !r._raise("filebeforeload", [D, w, n]) ? (W = !0, r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable()) : (r._previewFile(w, D, i, N, l), r._initFileActions(), void q())
                    }, n.onprogress = function(e) {
                        if (e.lengthComputable) {
                            var t = e.loaded / e.total * 100,
                                i = Math.ceil(t);
                            y = d.setTokens({ index: w + 1, files: u, percent: i, name: B }), setTimeout(function() { W || s.html(y) }, r.processDelay)
                        }
                    }, A ? n.readAsDataURL(D) : n.readAsArrayBuffer(D)
                }
        ...
        pause: function() {
            ...
            return i.showPreview && i._getThumbs().each(function() {
                ...
                a.removeClass("file-uploading"), n.attr("title") === s.indicatorLoadingTitle && (i._setThumbStatus(a, "Paused"), t = r.setTokens({ pendingTime: i.msgPaused, uploadSpeed: "" }), i.paused = !0, i._setProgress(o, a.find(".file-thumb-progress"), o + "%", t)), i._getThumbFile(a) || a.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")
        ...
        cancel: function() {
            var t, i = this,
                ...
                s = a.length;
            if (i.enableResumableUpload && o ? (o.cancel().done(function() { i._setProgressCancelled() }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : (i.ajaxPool && i.ajaxPool.cancel(), i._raise("fileuploadcancelled", [i.fileManager])), i._initAjax(), s > 0)
    ...
    e.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: { prev: '<i class="bi-chevron-left"></i>', next: '<i class="bi-chevron-right"></i>', toggleheader: '<i class="bi-arrows-expand"></i>', fullscreen: '<i class="bi-arrows-fullscreen"></i>', borderless: '<i class="bi-arrows-angle-expand"></i>', close: '<i class="bi-x-lg"></i>' },
