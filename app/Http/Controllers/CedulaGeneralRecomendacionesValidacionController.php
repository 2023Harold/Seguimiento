...
class CedulaGeneralRecomendacionesValidacionController extends Controller
{
    /**
    ...
    public function edit(Cedula $cedula)
    {
        ...
        return view('cedgralrecomendacionvalidacion.form',compact('nombre','auditoria','cedula'));
    }
    ...
    public function update(Request $request, Cedula $cedula)
    {
        ...
        Movimientos::create([
            'tipo_movimiento' => 'Validación de la Cédula General de Recomendación',
        ...
        if ($request->estatus == 'Aprobado') {           
            ...
            $titulo = 'Autorización de la Cédula General de Recomendación de la Auditoría No. '.$auditoria->numero_auditoria;

            $mensaje = '<strong>Estimado(a) '.auth()->user()->titular->name.', '.auth()->user()->titular->name.':</strong><br>'
                            .auth()->user()->name.', '.auth()->user()->puesto.
                            '; se ha aprobado la validación de la Cédula General de Recomendación de la Auditoría No. '.$auditoria->numero_auditoria.
