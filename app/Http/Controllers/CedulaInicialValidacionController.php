...
class CedulaInicialValidacionController extends Controller
{
    /**
    ...
    public function edit(Cedula $cedula)
    {
        ...
        return view('cedulageneralvalidacion.form',compact('nombre','auditoria','cedula'));
    }
    ...
    public function update(Request $request, Cedula $cedula)
    {
        ...
        Movimientos::create([
            'tipo_movimiento' => 'Validación de la Cédula General de Seguimiento',
        ...
        if ($request->estatus == 'Aprobado') {           
            ...
            $titulo = 'Autorización de la Cédula General de Seguimiento de la Auditoría No. '.$auditoria->numero_auditoria;
