...
class ComparecenciaRespuestaController extends Controller
{
    /**
    ...
    public function edit(Comparecencia $comparecencia)
    {
        ...
        return view('comparecenciarespuesta.form', compact('comparecencia', 'auditoria'));
    }
    ...
    public function update(Request $request, Comparecencia $comparecencia)
    {
        ...
        mover_archivos($request, ['oficio_respuesta']);
        $comparecencia->update($request->all());
        setMessage('La respuesta se han guardado correctamente');
