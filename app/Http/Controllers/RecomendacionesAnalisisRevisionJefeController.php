...
class RecomendacionesAnalisisRevisionJefeController extends Controller
{
    /**
    ...
    public function edit(Recomendaciones $recomendacion)
    {
        ...
        return view('recomendacionesatencionanalisisrevision02.form',compact('recomendacion','accion','auditoria'));
    }
