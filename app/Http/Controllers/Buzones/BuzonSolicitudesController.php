...
class BuzonSolicitudesController extends Controller
{
    protected $model;
    ...
    public function index(Request $request)
    {
        ...
        return view('Buzones.buzonsolicitudes.index', compact('auditorias', 'request',));
    }
    ...
    public function setQuery(Request $request) 
    {
        ...
        if ($apartado) {
            switch ($apartado) {
                case 'solicitudes_aclaracion':
                    $query->whereHas('accionessolacl', function($q) use ($status) {
                        $q->whereHas('solicitudesaclaracion', function($qr) use ($status) {
