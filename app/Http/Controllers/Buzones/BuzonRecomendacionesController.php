...
class BuzonRecomendacionesController extends Controller
{
    protected $model;
    ...
    public function index(Request $request)
    {
        ...
        return view('Buzones.buzonrecomendaciones.index', compact('auditorias', 'request',));
    }
        ...
        if ($apartado) {
            switch ($apartado) {
                ...
                case 'recomendaciones':
                    $query->whereHas('accionesrecomendaciones', function($q) use ($status) {
                        $q->whereHas('recomendaciones', function($qr) use ($status) {
