...
class PliegosObservacionAtencionCalificacionValidacionController extends Controller
{
    /**
    ...
    {        
        ...
        return view('pliegosobservacionatencioncalificacionvalidacion.form', compact('pliegosobservacion','auditoria','accion'));
    }
    ...
    public function update(Request $request, PliegosObservacion $pliegosobservacion)
    {
        ...
        Movimientos::create([
            'tipo_movimiento' => 'Validación de la calificación y la conclusión del pliego de observación',
