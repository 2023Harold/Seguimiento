...
class ComparecenciaActaRequest extends FormRequest
{
    ...
    public function attributes()
    {
        return [
            ...
            'oficio_designacion' => 'oficio de la designacion',
            'fecha_designacion' => 'fecha de la designacion',
            'nombre_representante'=>'nombre del representante',
            'cargo_representante1'=>'cargo del representante',
            'numero_identificacion_representante'=> 'numero de identificacion del representante',
            'tipo_identificacion'=>'tipo de identificacion',
            'tipo_identificacion1'=>'tipo de identificacion',
            'tipo_identificacion2'=>'tipo de identificacion',
