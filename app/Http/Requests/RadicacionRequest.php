...
class RadicacionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'fecha_inicio_proceso' => 'sometimes|nullable|required_if:acto_fiscalizacion_auditoria,Legalidad|date|max:10',
            'fecha_termino_proceso' => 'sometimes|nullable|required_if:acto_fiscalizacion_auditoria,Legalidad|date|max:10',
            ...
            'plazo_maximo'=>'sometimes|nullable|required_if:acto_fiscalizacion_auditoria,Legalidad|integer|max:120',
