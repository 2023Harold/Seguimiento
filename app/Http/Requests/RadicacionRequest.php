...
class RadicacionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'fecha_inicio_proceso' => 'sometimes|nullable|required_if:acto_fiscalizacion_auditoria,Legalidad,Cumplimiento Financiero,Inversión Física|date|max:10',
            'fecha_termino_proceso' => 'sometimes|nullable|required_if:acto_fiscalizacion_auditoria,Legalidad,Cumplimiento Financiero,Inversión Física|date|max:10',
            ...
            'plazo_maximo'=>'sometimes|nullable|required_if:acto_fiscalizacion_auditoria,Legalidad,Cumplimiento Financiero,Inversión Física|integer|max:120',
