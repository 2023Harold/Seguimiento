...
class AuditoriaAccionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'antecedentes_accion' => 'required|string',    
            'normativa_infringida' => 'sometimes|nullable|string|max:100000',      
            'fecha_termino_recomendacion' => 'sometimes|nullable|string|max:250',
