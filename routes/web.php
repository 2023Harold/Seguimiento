...
use App\Http\Controllers\AcuerdoConclusion\AcuerdoConclusionAutorizacionController;
use App\Http\Controllers\AcuerdoConclusion\AcuerdoConclusionController;
use App\Http\Controllers\AcuerdoConclusion\AcuerdoConclusionCPController;
use App\Http\Controllers\AcuerdoConclusion\AcuerdoConclusionCPEnvioController;
use App\Http\Controllers\AcuerdoConclusion\AcuerdoConclusionEnvioController;
use App\Http\Controllers\AcuerdoConclusion\AcuerdoConclusionRevisionController;
...
use App\Http\Controllers\Asignaciones\AsignacionLiderAnalistaController;
use App\Http\Controllers\Asignaciones\AsignacionDepartamentoController;
use App\Http\Controllers\Asignaciones\AsignacionStaffJuridicoController;
use App\Http\Controllers\Asignaciones\AsignacionStaffObservacionesController;
use App\Http\Controllers\Asignaciones\AsignacionDepartamentoEncargadoController;
use App\Http\Controllers\Asignaciones\AsignacionDireccionController;
use App\Http\Controllers\Asignaciones\AsignacionUnidadAdministrativa2022Controller;
use App\Http\Controllers\Asignaciones\AsignacionUnidadAdministrativa2023Controller;
use App\Http\Controllers\Asignaciones\AsignacionUnidadAdministrativaController;
...
use App\Http\Controllers\Cedulas\CedulaAnaliticaDesempenoRevision01Controller;
use App\Http\Controllers\Cedulas\CedulaAnaliticaDesempenoRevisionController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaDesempenoValidacionController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRecomendacionAnalistaController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRecomendacionAutorizacionController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRecomendacionRevision01Controller;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRecomendacionRevisionController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRecomendacionValidacionController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRevision01Controller;
use App\Http\Controllers\Cedulas\CedulaAnaliticaRevisionController;
use App\Http\Controllers\Cedulas\CedulaAnaliticaValidacionController;
use App\Http\Controllers\Cedulas\CedulasEnvioController;
use App\Http\Controllers\Cedulas\CedulaGeneralPrasAnalistaController;
use App\Http\Controllers\Cedulas\CedulaGeneralPRASAutorizacionController;
use App\Http\Controllers\Cedulas\CedulaGeneralPRASController;
use App\Http\Controllers\Cedulas\CedulaGeneralPRASLiderController;
use App\Http\Controllers\Cedulas\CedulaGeneralPRASRevision01Controller;
use App\Http\Controllers\Cedulas\CedulaGeneralPRASRevisionController;
use App\Http\Controllers\Cedulas\CedulaGeneralPRASValidacionController;
use App\Http\Controllers\Cedulas\CedulaGeneralRecomendacionesAnalistaController;
use App\Http\Controllers\Cedulas\CedulaGeneralRecomendacionesAutorizacionController;
use App\Http\Controllers\Cedulas\CedulaGeneralRecomendacionesController;
use App\Http\Controllers\Cedulas\CedulaGeneralRecomendacionesRevision01Controller;
use App\Http\Controllers\Cedulas\CedulaGeneralRecomendacionesRevisionController;
use App\Http\Controllers\Cedulas\CedulaGeneralRecomendacionesValidacionController;
use App\Http\Controllers\Cedulas\CedulaInicialAprobarAnalistaController;
use App\Http\Controllers\Cedulas\CedulaInicialAutorizacionController;
use App\Http\Controllers\Cedulas\CedulaInicialController;
use App\Http\Controllers\Cedulas\CedulaInicialPrimeraEtapaController;
use App\Http\Controllers\Cedulas\CedulaInicialRevision01Controller;
use App\Http\Controllers\Cedulas\CedulaInicialRevisionController;
use App\Http\Controllers\Cedulas\CedulaInicialValidacionController;
use App\Http\Controllers\Cedulas\CedulasRevisionController;
use App\Http\Controllers\Comparecencia\ComparecenciaActaController;
use App\Http\Controllers\Comparecencia\ComparecenciaAcusesController;
use App\Http\Controllers\Comparecencia\ComparecenciaAcusesCPController;
use App\Http\Controllers\Comparecencia\ComparecenciaAgendaController;
use App\Http\Controllers\Comparecencia\ComparecenciaController;
use App\Http\Controllers\Comparecencia\ComparecenciaCPEnvioController;
use App\Http\Controllers\Comparecencia\ComparecenciaEnvioController;
use App\Http\Controllers\Comparecencia\ComparecenciaRevisionController;
use App\Http\Controllers\Comparecencia\ComparecenciaValidacionController;
use App\Http\Controllers\ConstanciaController;
use App\Http\Controllers\CotejamientoController;
use App\Http\Controllers\CuentaPublicaHomeController;
use App\Http\Controllers\FirmaController;
use App\Http\Controllers\Folios\FolioCRRController;
use App\Http\Controllers\Folios\FolioAnexosController;
use App\Http\Controllers\Folios\FolioRemitentesController;
...
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAnalisisEnvioController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAnalisisRevision02Controller;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAnalisisRevisionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAnexoController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionAnalisisController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionCalificacionAutorizacionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionCalificacionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionCalificacionValidacionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionContestacionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAtencionDocumentosController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionAutorizacionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionRevision01Controller;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionRevisionController;
use App\Http\Controllers\PliegosObservacion\PliegosObservacionValidacionController;
use App\Http\Controllers\Pras\PrasController;
use App\Http\Controllers\Pras\PrasaccionesController;
use App\Http\Controllers\Pras\PrasMedidaController;
use App\Http\Controllers\Pras\PrasSeguimientoController;
use App\Http\Controllers\Pras\PrasTurnoAcusesController;
use App\Http\Controllers\Pras\PrasTurnoAutorizacionController;
use App\Http\Controllers\Pras\PrasTurnoController;
use App\Http\Controllers\Pras\PrasTurnoRevisionController;
use App\Http\Controllers\Pras\PrasTurnoValidacionController;
use App\Http\Controllers\QuickLoginController;
use App\Http\Controllers\Radicacion\RadicacionAutorizacionController;
use App\Http\Controllers\Radicacion\RadicacionController;
use App\Http\Controllers\Radicacion\RadicacionEnvioController;
use App\Http\Controllers\Radicacion\RadicacionRevisionController;
use App\Http\Controllers\Radicacion\RadicacionValidacionController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAccionesController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAcusesController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAnalisisController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAnalisisEnvioController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAnalisisRevisionController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAnalisisRevisionJefeController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAnexoController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAtencionCalificacionController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAtencionContestacionController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAtencionController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAtencionDocumentosController;
use App\Http\Controllers\Recomendaciones\RecomendacionesAutorizacionController;
use App\Http\Controllers\Recomendaciones\RecomendacionesController;
use App\Http\Controllers\Recomendaciones\RecomendacionesRevision01Controller;
...
use App\Http\Controllers\Reportes\ReporteNotificacionesController;
use App\Http\Controllers\Reportes\ReporteSesionController;
...
use App\Http\Controllers\Revisiones\RevisionesPliegosObservacionController;
use App\Http\Controllers\Revisiones\RevisionesRecomendacionesController;
use App\Http\Controllers\Revisiones\RevisionesSolicitudesAtencionController;
use App\Http\Controllers\Revisiones\RevisionesSolicitudesController;
use App\Http\Controllers\RolController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoria2023AutorizacionController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoria2023Controller;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoria2023Revision01Controller;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoria2023RevisionController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoria2023ValidacionController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaAccionRevision01Controller;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaAccionRevisionController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaAutorizacionController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaRevision01Controller;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaRevisionController;
use App\Http\Controllers\SeguimientoAuditoria\SeguimientoAuditoriaValidacionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAccionesController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAnalisisController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAnalisisEnvioController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAnalisisRevisionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAnalisisRevisionJefeController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAnexoController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAtencionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionAutorizacionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionCalificacionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionContestacionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionDocumentosController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionRevision01Controller;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionRevisionController;
use App\Http\Controllers\SolicitudAclaraciones\SolicitudesAclaracionValidacionController;
use App\Http\Controllers\Tipologias\TipologiaAccionController;
use App\Http\Controllers\Tipologias\TipologiaAccionesController;
use App\Http\Controllers\Tipologias\TipologiaAccionEnvioController;
use App\Http\Controllers\Tipologias\TipologiaAccionRevision01Controller;
use App\Http\Controllers\Tipologias\TipologiaAuditoriasController;

use App\Http\Controllers\TurnoArchivo\TurnoArchivoAutortizacionController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoEnvioController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoRevision01Controller;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoRevisionController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferencia;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferenciaAutorizacionController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferenciaControler;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferenciaController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferenciaEnvioController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferenciaRevisionController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoTransferenciaValidacionController;
use App\Http\Controllers\TurnoArchivo\TurnoArchivoValidacionController;
use App\Http\Controllers\TurnoContestacionArchController;
use App\Http\Controllers\TurnoContestacionController;
use App\Http\Controllers\TurnoContestacionOICController as ControllersTurnoContestacionOICController;
use App\Http\Controllers\TurnoOIC\TurnoOICAutorizacionController;
use App\Http\Controllers\TurnoOIC\TurnoOICController;
use App\Http\Controllers\TurnoOIC\TurnoOICEnvioController;
use App\Http\Controllers\TurnoOIC\TurnoOICRevisionController;
use App\Http\Controllers\TurnoOIC\TurnoOICValidacionController;
...
use App\Http\Controllers\TurnoUI\TurnoUIAutorizacionController;
use App\Http\Controllers\TurnoUI\TurnoUIController;
use App\Http\Controllers\TurnoUI\TurnoUIEnvioController;
use App\Http\Controllers\TurnoUI\TurnoUIRevisionController;
use App\Http\Controllers\TurnoUI\TurnoUIValidacionController;
...
/**Rutas para el manejo de sesiones y logging */
...
})->middleware(['web', 'auth'])->name('session.extend');

Route::get('/session/timeout-logout', function () {
    if (Auth::check()) {
        // Registrar logout por expiración si tienes el logging activo
        if (env('SESSION_LOGGING_ENABLED', false)) {
...
//* Fin de las rutas para el manejo de sesiones y logging */
...
/** Seguimiento - Auditorias - PAC */
 ...
 Route::get('/pacauditoria/mot/{id}', [PacController::class, 'mot'])->name('pacauditoria.mot');
 Route::get('/pacauditoria/fc/{id}', [PacController::class, 'fc'])->name('pacauditoria.fc');
 Route::get('/pacauditoria/fccd/{id}', [PacController::class, 'fccd'])->name('pacauditoria.fccd');
 /**    Lider       */
 ...
 Route::get('/pacauditoria/ofiaar/{id}', [PacController::class, 'ofiaar'])->name('pacauditoria.ofiaar');
 Route::get('/pacauditoria/ofaroics/{id}', [PacController::class, 'ofaroics'])->name('pacauditoria.ofaroics');
 Route::get('/pacauditoria/ac/{id}', [PacController::class, 'ac'])->name('pacauditoria.ac');
 /**    Jefe        */
...
Route::middleware(['auth', CheckPermission::class])->group(function() {
    ...
    //Route::resource('unidadadministrativaanterior/{cp}', AsignacionUnidadAdministrativaController::class);
    ...
    Route::get('/rescomrec/enviar/{respuesta}', [RespuestaComentariosRecomendacionesController::class, 'enviarcomentario'])->name('rescomrec.enviarcomentario');
     ...
     Route::get('/respuestacomentariossolicitudes/enviar/{respuesta}', [RespuestaComentariosSolicitudesController::class, 'enviarcomentario'])->name('respuestacomentariossolicitudes.enviarcomentario');
    ...
    Route::get('/respuestacomentariospliegos/enviar/{respuesta}', [RespuestaComentariosPliegosController::class, 'enviarcomentario'])->name('respuestacomentariospliegos.enviarcomentario');
...
//     // Route::resource('cedgralrecomendacionanalista', CedulaGeneralRecomendacionesAnalistaController::class, ['parameters' => ['cedgralrecomendacionanalista' => 'cedula']]);
   ...
   // Route::resource('cedulaanaliticavalidacion', CedulaAnaliticaValidacionController::class, ['parameters' => ['cedulaanaliticavalidacion' => 'cedula']]);
    ...
    /** Seguimiento - Auditorias - TurnoContestacion */
    Route::resource('turnocontestacionesui', TurnoContestacionController::class);
    Route::resource('turnocontestacionesoic', ControllersTurnoContestacionOICController::class);
    Route::resource('turnocontestacionesarc', TurnoContestacionArchController::class);
    /**Fin del apartado de Seguimiento - Auditorias - TurnoContestacion*/
    ...
    Route::get('reportenotificaciones/export-pdf',   [ReporteNotificacionesController::class, 'exportPdf'])->name('reportenotificaciones.exportPdf');
    Route::get('reportenotificaciones/export-excel', [ReporteNotificacionesController::class, 'exportExcel'])->name('reportenotificaciones.exportExcel');
    Route::resource('reportenotificaciones', ReporteNotificacionesController::class, ['parameters' => ['reportenotificaciones' => 'notificacion']]);
    Route::get('reportenotificaciones/{id}/goto', [ReporteNotificacionesController::class, 'goto'])->name('reportenotificaciones.goto');

    Route::get('reportesesion/export-pdf',   [ReporteSesionController::class, 'exportPdf'])->name('reportesesion.exportPdf');
    Route::get('reportesesion/export-excel', [ReporteSesionController::class, 'exportExcel'])->name('reportesesion.exportExcel');
    Route::get('reportesesion/{id}/export-pdf-show', [ReporteSesionController::class, 'exportPdfShow'])->name('reportesesion.exportPdfShow');
    Route::get('reportesesion/{id}/export-excel-show', [ReporteSesionController::class, 'exportExcelShow'])->name('reportesesion.exportExcelShow');
    Route::resource('reportesesion', ReporteSesionController::class);
