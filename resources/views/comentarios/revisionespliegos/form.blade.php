    ...
    <div class="card-body">
        ...
        {!!BootForm::open(['model' => $comentario, 'store' => 'revisionespliegos.store', 'update' => 'revisionespliegos.update', 'id' => 'form']) !!}
            <div class="row">
                ...
                @if($tipo == "Analisis")
                    <div class="col-md-12">
                        {!!BootForm::textarea('muestra_rev','Analisis: *', old('muestra_rev', optional($acciones->pliegosobservacion)->analisis),['rows'=>'10']) !!}
                    </div>
                @endif
                @if($tipo == "Conclusión")
                    <div class="col-md-12">
                        {!!BootForm::textarea('muestra_rev','Conclusión: *', old('muestra_rev', optional($acciones->pliegosobservacion)->conclusion),['rows'=>'10']) !!}
                    </div>
                @endif
                ...
                @if($tipo == "Listado Documentos")
                    <div class="col-md-12">
                        {!!BootForm::textarea('muestra_rev','Listado de Documentos: *', old('muestra_rev', optional($acciones->pliegosobservacion)->listado_documentos),['rows'=>'10']) !!}
                    </div>
                @endif
            </div>
            <div class="row">
