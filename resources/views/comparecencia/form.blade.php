...
@section('breadcrums')
@if ($accion=='Agregar')
    {{ Breadcrumbs::render('comparecencia.create') }}
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! BootForm::open(['model' => $comparecencia,'store' => 'comparecencia.store','update' => 'comparecencia.update','id' => 'form',]) !!}
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        {!! archivo('oficio_comparecencia','Oficio de notificación de la comparecencia: *',old('oficio_comparecencia', $comparecencia->oficio_comparecencia),) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        {!! BootForm::time('hora_comparecencia_termino','Hora de término de la comparecencia: *',old('hora_comparecencia_termino', $comparecencia->hora_comparecencia_termino)) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
