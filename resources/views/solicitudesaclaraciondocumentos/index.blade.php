...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            @button('Agregar',route('solicitudesaclaraciondocumentos.create'))
        </div>
    </div>
    <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{-- @can('comparecenciaanexo.destroy') --}}
                                        @destroy(route('solicitudesaclaraciondocumentos.destroy', $documento))
                                    {{-- @endcan --}}
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="pagination">
            {{ $documentos->appends(['consecutivo'=>$request->consecutivo,'nombre_archivo'=>$request->nombre_archivo])->links('vendor.pagination.bootstrap-5') }}
        </div>
    </div>
</div>
@endsection