@extends('layouts.app')
@section('breadcrums')
{{ Breadcrumbs::render('solicitudesaclanalisisrevision02.edit',$solicitud) }}
@endsection
@section('content')
<div class="card">
    ...
    <div class="card-body">
        ...
        <div>
            ...
            <div class="card-body mt-2">
                <div class="row">
                    {!! BootForm::open(['model' => $solicitud,'update' =>'solicitudesaclanalisisrevision02.update','id' =>'form',]) !!}           
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @btnSubmit('Guardar',route('solicitudesaclanalisisrevision02.update'))
