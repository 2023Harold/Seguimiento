    ...
    <table width="100%" >
        ...
        <tr style="border-collapse:separate;border-spacing:0 500px; vertical-align: middle;">
            ...
            <td colspan="6" style="text-align: center; width: 80%; color: white; background-color: #960048; vertical-align: middle;"> 
                <span style="font-size: .6rem;"><strong>Proceso de Atencion a Promoción de Responsabilidad Administrativa Sancionatoria</strong></span>
            </td>
        </tr>   
        <tr style="border-collapse:separate;border-spacing:0 500px;"> 
            <td></td>           
        ...
        <tr>
            <td colspan="2">
                <table style="border: 1px solid; border-collapse:collapse; border-color: #424242;" width="100%">
                    <tr>
                        <td colspan="2" style="text-align: center; width: 20%; color: white; background-color: #960048; border: 1px solid; border-color: #424242;"> <span style="font-size: .6rem;"><strong>PRAS determinadas</strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center; width: 20%; border: 1px solid; border-color: #424242;"><span style="font-size: .6rem;"><strong>{{ count($auditoria->totalpras) }}</strong></span></td>
                    </tr>
                </table>
            </td>
            <td colspan="2">
                <table style="border: 1px solid; border-collapse:collapse; border-color: #424242;" width="100%">
                    <tr>
                        <td colspan="2" style="text-align: center; width: 20%; color: white; background-color: #960048; border: 1px solid; border-color: #424242;"> <span style="font-size: .6rem;"><strong>PRAS atendidas</strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center; width: 20%; border: 1px solid; border-color: #424242;"><span style="font-size: .6rem;"><strong>{{ count($auditoria->totalsolventadopras) }}</strong></span></td>
                    </tr>
                </table>
            </td>
            <td colspan="2">
                <table style="border: 1px solid; border-collapse:collapse; border-color: #424242;" width="100%">
                    <tr>
                        <td colspan="2" style="text-align: center; width: 20%; color: white; background-color: #960048; border: 1px solid; border-color: #424242;"> <span style="font-size: .6rem;"><strong>PRAS no atendidas</strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center; width: 20%; border: 1px solid; border-color: #424242;"><span style="font-size: .6rem;"><strong>{{ count($auditoria->totalNOsolventadopras) }}</strong></span></td>
                    </tr>
                </table>
            </td>
        ...
        <tr style="border-collapse:collapse;border-spacing:0 500px;">
            <td colspan="8"> 
                <table style="border: 1px solid; border-collapse:collapse; border-color: #424242;" width="100%">
                    <tr>
                        <td colspan="8" style="text-align: center; width: 20%; color: white; background-color: #960048; border: 1px solid; border-color: #424242;"> <span style="font-size: .6rem;"><strong>Promoción de Responsabilidad Administrativa Sancionatoria</strong></span></td> 
                    </tr>
                    <tr>
                        <td colspan="6" style="text-align: center; width: 40%; color: black; background-color: #D8D8D8; border: 1px solid; border-color: #424242;"> <span style="font-size: .6rem;"><strong>PRAS Determinada</strong></span></td>
