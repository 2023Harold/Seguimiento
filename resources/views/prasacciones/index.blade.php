                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('seguimientoauditoria.accionesconsulta', $auditoria) }}"
                                ...
                                <td class="text-center">
                                    @if
                                    (empty($auditoria->fase_autorizacion)||$auditoria->fase_autorizacion=='Rechazado')
                                    ...
                                    <a href="{{ route('seguimientoauditoriarevisionlp.edit',$auditoria) }}"
                                    ...
                                    <a href="{{ route('seguimientoauditoriarevision.edit',$auditoria) }}"
                                        class="btn btn-primary">
                                        Revisar
                                    </a>
                                    @endcan
                                    ...
                                    <a href="{{ route('seguimientoauditoriavalidacion.edit',$auditoria) }}"
                                        class="btn btn-primary">
                                        Validar
                                    </a>
                                    @endcan
                                    ...
                                    <a href="{{ route('seguimientoauditoriaautorizacion.edit',$auditoria) }}"
                                        class="btn btn-primary">
                                        Autorizar
                                    </a>
                                    @endcan
