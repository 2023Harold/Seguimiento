<h3 class="card-title text-primary">Informe Primera Etapa   {{  ucfirst($informeprimeraetapa->tipo) }}     </h3> 
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12 col-12">              
                ...
                <span class="text-sistema">
                    <a href="{{ asset($auditoria->informeprimeraetapa->informe) }}" target="_blank">
    ...
    <div class="row">
        <div class="col-lg-5 col-md-6 col-sm-12 col-12">              
             ...
             <span class="text-sistema">
                <a href="{{ asset($auditoria->informeprimeraetapa->acuse_envio) }}" target="_blank">
    ...
    <div class="row">
        <div class="col-lg-5 col-md-6 col-sm-12 col-12">              
             ...
             <span class="text-sistema">
                <a href="{{ asset($auditoria->informeprimeraetapa->acuse_notificacion) }}" target="_blank">
