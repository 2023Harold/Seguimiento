            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    <div class="card-body">
                        ...
                        {!! BootForm::open(['model' => $pras,'update'=>'prasturnoautorizacion.update','id'=>'form'] )!!}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 justify-content-end">
                                    {{-- @can('prasturnoautorizacion.update') --}}
                                        {{-- <button type="button" id='btn-firma' class="btn btn-primary" onclick="ConfirmFirma();">Guardar</button> --}}
                                        <button type="submit" id='btn-firma' class="btn btn-primary" >Guardar</button>
                                    {{-- @endcan --}}
                                <a href="{{ route('prasturno.index') }}" class="btn btn-secondary me-2">Cancelar</a>
                                </div>
                            </div>
                        {!! BootForm::close() !!}
                    </div>
