@extends('layouts.app')
@section('breadcrums')
{{ Breadcrumbs::render('solicitudesaclaracionanexos.index',$solicitud,$auditoria) }}
@endsection
@section('content')
<div class="row">
    ...
    <div class="col-md-9 mt-2">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">
                    <a href="{{ route('solicitudesaclaracionanalisis.edit',$solicitud) }}"><i
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <span>
                            <a class="btn btn-primary float-end" href="{{ route('solicitudesaclaracionanexos.create') }}">
                                Agregar
                            </a>
                        </span>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{-- @can('comparecenciaanexo.destroy') --}}
                                                @destroy(route('solicitudesaclaracionanexos.destroy', $anexo))
                                            {{-- @endcan --}}
                                        </td>
                                    </tr>
                                @endforeach
