    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!!BootForm::open(['route'=>'buzonturnoui.index','method'=>'GET']) !!}
                    <div class="row">
                        {!!BootForm::hidden('apartado',"turno_ui") !!}
                        <div class="col-md-2">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>No. Auditoria</th>
                                <th class="text-center ">Turno UI</th>
                        ...
                        <tbody>
                            @forelse ($auditorias as $auditoria)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('buzonseg.show', $TUI) }}" class="corner-button">
                                            <span class="cb-content">Turno UI<i class="bi bi-arrow-up-right-circle-fill text-primary fs-1" aria-hidden="true"></i></span>
                                        </a>
                                    </td>               
                                </tr>
                            @empty
