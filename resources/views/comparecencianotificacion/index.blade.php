                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                {{-- <th>Acuse del oficio de notificación de la comparecencia</th> --}}
                                {{-- <th>Cédula general</th> --}}
                                {{-- <th>Acta de comparecencia</th> --}}
                                {{-- <th>Respuesta de la Entidad Fiscalizable</th> --}}
                                <th>Acción / Constancia</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($auditorias as $auditoria)
                                <tr>
                                    ...
                                    <td class="text-center"> 
                                        ...
                                        @elseif(!empty($auditoria->comparecencia->oficio_comparecencia))
                                            hola
                                        @endif
                                    </td> 
                                    {{-- <td></td> 
