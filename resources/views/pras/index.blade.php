            ...
            <div class="table-responsive">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            {!! BootForm::text('entidad_fiscalizable', "Entidad fiscalizable:",
                            old('entidad_fiscalizable',
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width='30%'>
                                        ...
                                        {{ mb_convert_encoding(mb_convert_case(strtolower($entidadparcial),
                                        MB_CASE_TITLE),
                                        "UTF-8"); }}<br>
                                        @endforeach
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('prasacciones.edit',$auditoria->comparecencia) }}"
                                            class="btn btn-primary">
                                            <i class="align-middle fas fa-file-plus" aria-hidden="true"></i> Adjuntar
                                        </a>
                                        @endcan
                                        @else
                                        @can('prasacciones.show')
                                        <a href="{{ route('prasacciones.show', $auditoria->comparecencia) }}"
                                            class="btn btn-secondary">
                                            <img alt="Logo" src="{{asset('assets/img/consultar.png')}}"
                                                class="h-30px logo" />
                                        </a>
                                        @endcan
                                        @endif
