        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @forelse ($acciones as $accion)
                                <tr>
                                    <td>
                                        {{ $accion->auditoria->numero_auditoria }}
                                    </td>
                                    <td  width='40%'>
                                        @php
                                            $entidadparciales = explode("-", $accion->auditoria->entidad_fiscalizable);                                            
                                        @endphp
                                    ...
                                    <td>
                                        {{ $accion->auditoria->acto_fiscalizacion }}
                                    </td>
                ...
                <div class="pagination">
                    {{ $acciones->appends(['numero_auditoria'=>$request->numero_auditoria,'entidad_fiscalizable'=>$request->entidad_fiscalizable,'acto_fiscalizacion'=>$request->acto_fiscalizacion])->links('vendor.pagination.bootstrap-5') }}
                </div>
            </div>            
        </div>
    </div>
