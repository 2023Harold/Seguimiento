...
@section('Titulo')
Autorización de atención de la solicitud de aclaración.
@endsection
@section('content')
<span
...
<table border="0" width="100%">
        ...
        <td colspan="3" width="100%">
            ...
            <span
                style="font-family: Arial; color: #030303; font-size: 10px;">               
                    @if ($modelo->calificacion_sugerida=='Solventada')
                        <span class="badge badge-light-success">Atendida</span>
                    @endif
                    @if ($modelo->calificacion_sugerida=='No Solventada')
                        <span class="badge badge-light-danger">No Solventada</span>
                    @endif
                    @if ($modelo->calificacion_sugerida=='Solventada Parcialmente')
    ...
    @if (!empty($modelo->promocion))
        ...
        <tr>
            <td colspan="3" width="100%">
                ...
                <span
                    style="font-family: Arial; color: #030303; font-size: 10px;">{{ $modelo->monto_promocion }}</span>
    ...
    <tr>
        <td width="33%">
            ...
            <span
                style="font-family: Arial; color: #030303; font-size: 10px;">{{ $accion->monto_aclarar }}</span>

        </td>    
        <td width="33%">
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Importe solventado:</span>
            <span
                style="font-family: Arial; color: #030303; font-size: 10px;">{{ $modelo->monto_solventado }}</span>

        </td>    
        <td width="34%">
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Importe no solventado:</span>
            <span
                style="font-family: Arial; color: #030303; font-size: 10px;">{{ ($accion->monto_aclarar-$modelo->monto_solventado) }}</span>
