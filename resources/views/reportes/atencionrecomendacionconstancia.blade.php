...
@section('Titulo')
Registro de atención de la recomendación.
@endsection
@section('content')
<span
...
<table width="100%">
    ...
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Evidencia documental que acredite la
                atención de la recomendación: </span>
            <span style="font-family: Arial; color: #030303; font-size: 10px;">{{ $accion->evidencia_recomendacion }}
            </span>
        </td>
    </tr>
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Tipo de recomendación:</span>
            <span style="font-family: Arial; color: #030303; font-size: 10px;">{{ $accion->tipo_recomendacion }} </span>
        </td>
    </tr>
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Tramo de control recomendación: </span>
            <span style="font-family: Arial; color: #030303; font-size: 10px;">{{$accion->tipo_recomendacion}}</span>
        </td>
    </tr>
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Fecha de término: </span>
            <span
                style="font-family: Arial; color: #030303; font-size: 10px;">{{ fecha($accion->fecha_termino_recomendacion)  }}</span>
        </td>
    </tr>
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Plazo convenido: </span>
            <span style="font-family: Arial; color: #030303; font-size: 10px;">{{ $accion->plazo_recomendacion }}</span>
        </td>
    </tr>
</table>
<hr>
...
<table>
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Nombre del responsable de atender las
                recomendaciones por parte de la entidad fiscalizable: </span><br>
            <span style="font-family: Arial; color: #030303; font-size: 10px;">{{ $modelo->nombre_responsable }}</span>
        </td>
    </tr>
    <tr>
        <td>
            <span style="font-family: Arial; color: #4A4A4A; font-size: 10px;">Cargo del responsable de atender las
                recomendaciones por parte de la entidad fiscalizable: </span><br>
            <span style="font-family: Arial; color: #030303; font-size: 10px;">{{ $modelo->cargo_responsable }}</span>
        </td>
    </tr>
</table>
