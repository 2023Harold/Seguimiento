...
<div>
        <p style="font-family: Arial; color: #000000; font-size: 14px; text-align: justify;">
            V I S T O el memorándum número <span style="color: blue;">{{$modelo->num_memo_recepcion_expediente}}</span>, presentado por <span style="color: blue;">XXXXX</span>, <span style="color: blue;">XXXXX</span> del Órgano Superior de Fiscalización del Estado de México, 
            ...
            con fundamento en los artículos 1, 3, 4 fracción , 5, 6, 7, 8, 9, 21, 42 Bis, 53 fracción XXX, 54, 54 Bis, 55 párrafo segundo y 59 de la Ley de Fiscalización Superior del Estado de México y; 
            3 fracciones XIII Bis y XXIII Bis, 4, 6 fracciones III, XVIII, XIX, XXV y XXXVII, 23, 26 fracción XXXI y 47 del Reglamento Interior del Órgano Superior de Fiscalización del Estado de México; se emite el siguiente: <br><br>
        </p>        
        ...
        <p style="font-family: Arial; color: #000000; font-size: 14px; text-align: justify;">
            ...
            para el efecto de que dicha autoridad continúe con las investigaciones pertinentes y promueva las acciones procedentes. <br><br>
            
            <strong>SEXTO.</strong> En términos de los artículos 14 y 16 de la Constitución Política de los Estados Unidos Mexicanos; 53, 54 y 54 Bis de la Ley de Fiscalización Superior del Estado de México y; 6 fracciones XXV y XXXVII y 47 fracciones III, IV, XII y XIX del 
            ...
            <span style="color: blue;">{{$relacion4['horastxt']}}</span> horas y <span style="color: blue;">{{$relacion4['mintxt']}}</span> minutos, del día <span style="color: blue;">{{$relacion4['fechacomparecenciatxt']}}</span> en el domicilio de la Unidad de Seguimiento de este Órgano Superior de 
            ...
            <strong>SÉPTIMO.</strong> Se ordena el inicio de la Etapa de Aclaración y del Proceso de Atención a las Recomendaciones de las observaciones subsistentes en materia Financiera y de Obra y, que se encuentran detalladas en el multicitado Informe de Auditoría; por lo cual, con fundamento en lo dispuesto en los artículos 54 fracción I  
            y 54 Bis fracción II  de la Ley de Fiscalización Superior del Estado de México, se concede a la entidad fiscalizada un plazo de 30 (Treinta) días hábiles contados a partir del día <span style="color: blue;">{{$relacion4['fechainicioaclaraciontxt']}}</span> y que fenece el día <span style="color: blue;">{{$relacion4['fechaterminoaclaraciontxt']}}</span>, 
            ...
            justifique su improcedencia, con el apercibimiento de que, en caso de no dar cumplimiento en el plazo concedido, se entenderán por no atendidas ni justificadas dichas observaciones. <br><br>
    ...
    <div style="page-break-before: always;">
        <p style="font-family: Arial; color: #000000; font-size: 14px; text-align: justify; page-break-inside: always;">
            ...
            <strong>NOVENO.</strong> En términos de Ley, notifíquese el presente proveído a la entidad fiscalizada y al Órgano Interno de Control de <span style="color: blue;">{{$auditoria->entidad_fiscalizable}}
                </span>, o a su equivalente. <br><br>
