...
<div>
        <p style="font-family: Arial; color: #000000; font-size: 14px; text-align: justify;">
            ...
            con fundamento en los artículos 1, 3, 4 fracción <span style="color: blue;">{{$auditoria->entidadFiscalizable->Ambito=='Municipal'?'II. Los municipios del Estado de México. IV. Los Organismos Auxiliares. V. Los fideicomisos previstos en el artículo 3 fracción XVII del Código Financiero del Estado de México y Municipios, y aquellos que manejen recursos del Estado, Municipios, o en su caso provenientes de la federación;':
            ($auditoria->entidadFiscalizable->Ambito=='Estatal'?'I. Los Poderes Públicos del Estado. III. Los organismos autónomos. IV. Los Organismos Auxiliares. V. Los fideicomisos previstos en el artículo 3 fracción XVII del Código Financiero del Estado de México y Municipios, y aquellos que manejen recursos del Estado, Municipios, o en su caso provenientes de la federación':'')}}</span>
        ...
        <p style="font-family: Arial; color: #000000; font-size: 14px; text-align: justify;">
            ...
            para el efecto de que dicha autoridad {{$auditoria->entidadFiscalizable->Ambito}} continúe con las investigaciones pertinentes y promueva las acciones procedentes. <br><br>
