    ...
    <div class="card-body">
        ...
        <div>
            ...
            <div class="card-body mt-2">
                <div class="row">
                    {!! BootForm::open(['model' => $pliegosobservacion,'update' =>'pliegosobservacionanalisisrevision02.update','id' =>'form',]) !!}
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @btnSubmit('Guardar',route('pliegosobservacionanalisisrevision02.update'))
