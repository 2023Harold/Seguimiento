@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('turnoarchivotransferenciaautorizacion.edit',$turnoarchivotransferencia) }}  
@endsection
@section('content')
<div class="row">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! BootForm::open(['model' => $turnoarchivotransferencia,'update'=>'turnoarchivotransferenciaautorizacion.update','id'=>'form'] )!!}
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 justify-content-end">
                        @can('turnoarchivotransferenciaautorizacion.update')
