@extends('layouts.app')
@section('breadcrums')
{{ Breadcrumbs::render('recomendacionesanexos.index',$recomendacion,$auditoria) }}
@endsection
@section('content')
<div class="row">
    ...
    <div class="col-md-9 mt-2">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">
                    <a href="{{ route('recomendacionesanalisis.edit',$recomendacion) }}"><i class="fa fa-arrow-alt-circle-left fa-1x text-primary"></i></a>
                    &nbsp;Anexos
                </h1>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <span>
                            <a class="btn btn-primary float-end" href="{{ route('recomendacionesanexos.create') }}">
                                Agregar
                            </a>
                        </span>
                    </div>
                ...
                <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{-- @can('comparecenciaanexo.destroy') --}}
                                                @destroy(route('recomendacionesanexos.destroy', $anexo))
                                            {{-- @endcan --}}
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <a class="btn btn-primary" href="{{ route('recomendacionesatencion.index') }}">
                        Continuar
                    </a>
                </div>
