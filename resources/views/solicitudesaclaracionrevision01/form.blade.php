@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('solicitudesaclaracionrevision01.edit', $solicitud)}}
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title">
                        <a href="{{ route('solicitudesaclaracioncalificacion.index') }}"><i class="fa fa-arrow-alt-circle-left fa-1x text-primary"></i></a> &nbsp;
                        Revisar
                    </h1>
                </div>
                <div class="card-body">
                    ...
                    {!! BootForm::open(['model' => $solicitud,'update'=>'solicitudesaclaracionrevision01.update','id'=>'form'] )!!}
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 justify-content-end">
                                ...
                                <a href="{{ route('solicitudesaclaracioncalificacion.index') }}" class="btn btn-secondary me-2">Cancelar</a>
                            </div>
                        </div>
                    {!! BootForm::close() !!}
                </div>
