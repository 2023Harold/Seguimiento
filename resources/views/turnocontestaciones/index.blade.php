@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('turnocontestacionesui.index', $auditoria) }}
@endsection
@section('content')
    <div class="row">
        ...
        <div class="col-md-9 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                            ...
                            <span class="text-primary">
                                {{ fecha($turno->fecha_turno_oi) }}
                            </span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                            <label>Número de oficio: </label>
                            <span class="text-primary">
                                {{ $turno->numero_turno_ui }}
                            </span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                            <label>Acuse de notificación: </label>
                            <span class="text-primary">
                               @btnFile($turno->turno_ui)
                            </span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                            <label>Fecha de notificación: </label>
                            <span class="text-primary">
                                {{ fecha($turno->fecha_notificacion_ui) }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                 @can('turnocontestacionesui.create')
                                    <a class="btn btn-primary float-end" href="{{ route('turnocontestacionesui.create') }}">
                            ...
                            <tbody>
                                @forelse ($contestaciones as $contestacion)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                             <a href="{{ route('turnocontestacionesui.edit',$contestacion) }}">
                                                <span class="fa fa-edit"></span>
                                            </a>
                                        </td>
                                        <td class="text-center">
                                             @destroy(route('turnocontestacionesui.destroy', $contestacion))
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
