...
@section('breadcrums')
    {{ Breadcrumbs::render('asignarequipotrabajo.edit', $auditoria) }}
@endsection
...
<div class="card">
    <div class="card-header">
        <h1 class="card-title">
            ...
            &nbsp; Gestión del Equipo de Trabajo - {{ $acc }}
        </h1>
    </div>
    <div class="card-body">
        ...
        {!!BootForm::open(['model' => $auditoria,'update' => 'asignarequipotrabajo.update','id' => 'form']) !!}
