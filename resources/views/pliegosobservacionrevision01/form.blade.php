@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('pliegosobservacionrevision01.edit', $pliegosobservacion, $auditoria)}}
@endsection
@section('content')
    <div class="row">
        ...
        <div class="col-md-9 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! BootForm::open(['model' => $pliegosobservacion,'update'=>'pliegosobservacionrevision01.update','id'=>'form'] )!!}
