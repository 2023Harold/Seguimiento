@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('radicacionrevision.edit', $radicacion, $auditoria)}}
@endsection
@section('content')
    <div class="row">
        ...
        <div class="col-md-9 mt-2">      
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! BootForm::open(['model' => $radicacion,'update'=>'radicacionrevision.update','id'=>'form'] )!!}
                        <div class="row">
                            <div class="col-md-6">
