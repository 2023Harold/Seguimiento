                ...
                <table style="border: 1px solid; border-collapse:collapse; border-color: #424242;" width="100%">
                    ...
                    @foreach ($auditoria->totalrecomendacion as $recomendacion)
                        <tr>
                            ...
                            <td style="text-align: center; width: 10%; border: 1px solid; border-color: #424242;"><span style="font-size: .6rem;"><strong>{{ $recomendacion->recomendaciones->calificacion_sugerida }}</td>
                        </tr>                        
                    @endforeach
                </table>
            </td>                       
