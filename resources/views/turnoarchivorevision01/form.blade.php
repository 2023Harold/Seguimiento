@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('turnoarchivorevision01.edit',$turnoarchivo) }}
@endsection
@section('content')
<div class="row">
    ...
    <div class="col-md-9 mt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! BootForm::open(['model' => $turnoarchivo,'update'=>'turnoarchivorevision01.update','id'=>'form'] )!!}
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 justify-content-end">
                        @can('turnoarchivorevision01.update')
