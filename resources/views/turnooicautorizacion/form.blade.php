@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('turnooicautorizacion.edit',$turnooic) }}  
@endsection
@section('content')
<div class="row">
    ...
    <div class="col-md-9 mt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! BootForm::open(['model' => $turnooic,'update'=>'turnooicautorizacion.update','id'=>'form'] )!!}
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 justify-content-end">
                        @can('turnooicautorizacion.update')
