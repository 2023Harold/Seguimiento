        ...
        <div class="col-md-9 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                @if (!empty($turnooic))
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if (empty($auditoria->turnooic->fase_autorizacion) || $auditoria->turnooic->fase_autorizacion == 'Rechazado')
                                                <span
                                                    class="badge badge-light-danger">{{ $auditoria->turnooic->fase_autorizacion }}
                                                </span>
                                                @can('turnooic.edit')
                                                    <a href="{{ route('turnooic.edit', $auditoria->turnooic) }}"
                                            ...
                                            @if ($auditoria->turnooic->fase_autorizacion == 'En revisión')
                                                @can('turnooicrevision.edit')
                                                    <a href="{{ route('turnooicrevision.edit', $auditoria->turnooic) }}"
                                                        class="btn btn-primary">
                                                ...
                                                @else
                                                    <span
                                                        class="badge badge-light-warning">{{ $auditoria->turnooic->fase_autorizacion }}
                                                    </span>
                                                @endcan
                                            @endif
                                            @if ($auditoria->turnooic->fase_autorizacion == 'En validación')
                                                @can('turnooicvalidacion.edit')
                                                    <a href="{{ route('turnooicvalidacion.edit', $auditoria->turnooic) }}"
                                                        class="btn btn-primary">
                                                        <li class="fa fa-gavel"></li>
                                                        Validar
                                                    </a>
                                            ...
                                            @if ($auditoria->turnooic->fase_autorizacion == 'En autorización')
                                                @can('turnooicautorizacion.edit')
                                                    <a href="{{ route('turnooicautorizacion.edit', $auditoria->turnooic) }}"
                                                        class="btn btn-primary">
                                                        <li class="fa fa-gavel"></li>
                                                        Autorizar
                                                    </a>
                                            ...
                                            @if ($auditoria->turnooic->fase_autorizacion == 'Autorizado')
                                                <span
                                                    class="badge badge-light-success">{{ $auditoria->turnooic->fase_autorizacion }}
                                                </span>
                                            @endif
                                        </td>
                                        @if (empty($auditoria->turnooic->fase_autorizacion) || $auditoria->turnooic->fase_autorizacion == 'Rechazado')
                                            <td>
                                                @can('turnooic.edit')
                                                    <a href="{{ route('turnooicenvio.edit', $auditoria->turnooic) }}"
                                                        class="btn btn-primary">
                                                        Enviar
                                                    </a>
                                                @endcan
                    ...
                    @can('turnooic.contestaciones')
                        @if (!empty($turnooic->fase_autorizacion) && $turnooic->fase_autorizacion == 'Autorizado')
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('turnooic.contestaciones', $turnooic) }}" class="btn btn-primary float-end">
                                        Contestaciones
                                    </a>
                                </div>
                            </div>
