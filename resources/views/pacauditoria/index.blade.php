    ...
    <div class="col-md-9 mt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($siglas_rol=="ANA"||$siglas_rol=="LP"||$siglas_rol=="JD"||$siglas_rol=="DS"||$siglas_rol=="TUS")
                <div class="row">                
                    <div class="card card-bordered border-primary">  
                        ...
                        <div class="card-body ">                                              
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="{{ route('pacauditoria.fc',2) }}" class="card card-a  text-gray-700 align-items-center mbs">
                                        <div class="card-body d-flex align-items-center pulses">
                                            <span class="bi bi-file-earmark-text fs-2x">                                    
                                            </span> 
                                ...
                                <div class="col-md-4">
                                    <a href="{{ route('pacauditoria.fccd',3) }}" class="card card-a text-gray-700 align-items-center mbs">
                                        <div class="card-body d-flex align-items-center pulses">
                                            <span class="bi bi-file-earmark-text fs-2x">                                    
                                            </span> 
                                            <span class="ms-3 fs-6 fw-bold">
                ...
                @endif
                @if ($siglas_rol=="LP"||$siglas_rol=="JD"||$siglas_rol=="DS"||$siglas_rol=="TUS")
                <div class="row">
                    <div class="card card-bordered border-primary"> 
                        <div class="ribbon ribbon-top">
                        ...
                        <div class="card-body ">                                                   
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pacauditoria.ofiaar',2) }}" class="card card-a text-gray-700   align-items-center ">
                                        <div class="card-body d-flex align-items-center">
                                            <span class="bi bi-file-earmark-text fs-2x">                                    
                                            </span> 
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pacauditoria.ofaroics',3) }}" class="card card-a text-gray-700   align-items-center">
                                        <div class="card-body d-flex align-items-center">
                                            <span class="bi bi-file-earmark-text fs-2x">                                    
                                            </span> 
                                            <span class="ms-3 fs-6 fw-bold">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pacauditoria.ac',1) }}" class="card card-a text-gray-700   align-items-center ">
                                        <div class="card-body d-flex align-items-center ">
                                            <span class="bi bi-file-earmark-text fs-2x">                                    
                                            </span>                        
                                            <span class="ms-3 fs-6 fw-bold">
                ...
                @endif
                @if ($siglas_rol=="JD"||$siglas_rol=="DS"||$siglas_rol=="TUS")
                <div class="row">                
                    <div class="card card-bordered border-primary">  
                        <div class="ribbon ribbon-top">
                ...
                @endif
                @if ($siglas_rol=="DS"||$siglas_rol=="TUS")
                <div class="row">                
                    <div class="card card-bordered border-primary">  
                        <div class="ribbon ribbon-top">
