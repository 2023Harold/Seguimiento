        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! BootForm::open(['model' => $auditoria,'update'=>'seguimientoauditoriarevision.update','id'=>'form'] )!!}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                                @if ($accion->revision_jefe=='Aprobado')
                                                    <span class="badge badge-light-success">Apraboda</span>
                                                @elseif ($accion->revision_jefe=='Rechazado')
                        ...
                        @if (count($auditoria->accionesrevisadasjefe) == count($auditoria->acciones))
                            <div class="row">
                                <div class="col-md-6">
