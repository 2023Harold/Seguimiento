...
@else
    {{ Breadcrumbs::render('acuerdoconclusion.edit',$acuerdoconclusion,$comparecencia) }}
@endif
@endsection
@section('content')
<div class="row">
    ...
    <div class="col-md-9 mt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class= "row">
                    <div class="col-md-5">
                        {!!BootForm::text('nombre_titular','Nombre del titular a quien se dirige la comparecencia: *',old('nombre_titular', optional($auditoria->comparecencia)->nombre_titular),) !!}
                    </div>
                    <div class="col-md-3">
                        {!! BootForm::text('cargo_titular', 'Cargo del titular a quien se dirige : *', old('cargo_titular', optional($auditoria->comparecencia)->cargo_titular),) !!}
                    </div>
                </div>
                <div class= "row">
                    <div class="col-md-5">
                        {!!BootForm::text('domicilio_notificacion','Domicilio: *',old('domicilio', optional($auditoria->comparecencia)->domicilio_notificacion),) !!}                    </div>
                    </div>
				<div class="row">
					<div class="col-md-4">
