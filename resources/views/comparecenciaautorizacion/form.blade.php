            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                        ...
                        {!! BootForm::open(['model' => $comparecencia,'update'=>'comparecenciaautorizacion.update','id'=>'form'] )!!}
                        {!! BootForm::hidden('archivo_firmar',$b64archivoxml,['id'=>'archivo_firmar'])!!}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 justify-content-end">
                                    {{-- @can('comparecenciaautorizacion.update') --}}
                                        <button type="button" id='btn-firma' class="btn btn-primary" onclick="ConfirmFirma();">Firmar y guardar</button>
                                    {{-- @endcan --}}
                                <a href="{{ route('comparecencia.index') }}" class="btn btn-secondary me-2">Cancelar</a>
                                </div>
                            </div>
                        {!! BootForm::close() !!}
                    </div>                    
