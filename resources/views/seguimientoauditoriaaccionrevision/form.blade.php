@extends('layouts.app')
@section('breadcrums')
    {{ Breadcrumbs::render('seguimientoauditoriaaccionrevision.edit',$auditoria,$accion) }}
@endsection
@section('content')
<div class="card">
    <div class="card-header">
        <h1 class="card-title">
            <a href="{{ route('seguimientoauditoriarevision.edit',$auditoria) }}"><i class="fa fa-arrow-alt-circle-left fa-1x text-primary"></i></a>
            &nbsp; Revisar acción
        </h1>
    </div>
    <div class="card-body">
        ...
        <div class="card-body py-7">
            ...
            <hr/>
            {!! BootForm::open(['model' => $accion,'update'=>'seguimientoauditoriaaccionrevision.update','id'=>'form'] )!!}
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row mt-3">
                <div class="col-md-6 justify-content-end">
                    ...
                    <a href="{{ route('seguimientoauditoriarevision.edit',$auditoria) }}" class="btn btn-secondary me-2">Cancelar</a>
                </div>
            </div>
        {!! BootForm::close() !!}
        </div>
